...
KERNEL_FQ KERNEL_FA void m19851_mxx (KERN_ATTR_VECTOR ())
{
  /**
   * modifier
   */
  ...
  for (u32 il_pos = 0; il_pos < IL_CNT; il_pos += VECT_SIZE)
  {
    ...
    crypt_derive_key_ipad (ipad_key, w, pw_len);
    crypt_derive_key_opad (opad_key, w, pw_len);
...
KERNEL_FQ KERNEL_FA void m19851_sxx (KERN_ATTR_VECTOR ())
{
  /**
   * modifier
   */
